...
CREATE TABLE `read_posts` (
  ...
  KEY `post_id` (`post_id`),
  CONSTRAINT `read_posts_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `read_posts_ibfk_2` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`)
...
-- Dump completed on 2025-03-15 14:36:27
